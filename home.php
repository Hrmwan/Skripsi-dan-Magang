...
// // cek apakah ada kiriman dari form method input
// if ($_SERVER["REQUEST_METHOD"] == "POST") {
//     $kunci = $_POST['key_enkripsi'];
//     $nama_file = $_POST['file'];
//     $nama_gambar = $_POST['gambar'];

//     // query input sql
//     $sql = "INSERT INTO tbl_enkripsi (kunci, nama_file, nama_gambar) VALUES ('$kunci','$nama_file','$nama_gambar')";
...
<body>
    ...
    <div class="text-center">
        ...
        <a href="history.php" class="btn btn-primary"><i class="fa fa-file"></i> History </a>
            ...
            <form action="enkripsi.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="text-right">
                        <button type="submit" name="enkripsi" class="btn" id="btn-enkrip" style="background-color: #0F0F0F; color:#fff;">Encrypt Now <i class="fa fa-check"></i></button>
                    </div>
            </form>
