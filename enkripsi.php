...
$nama_file = $target_file1;
$nama_gambar = $target_file;
$hasilenkripsi = $file_stego;

// query input sql
$sql = "INSERT INTO tbl_enkripsi (kunci, nama_file, nama_gambar, hasilenkripsi) VALUES ('$kunci','$nama_file','$nama_gambar', '$hasilenkripsi')";
